//Form JS File
function frmApplicationStatus_frmApplicationStatus_init_seq0(eventobject, neworientation) {
    leftMenuAssignment.call(this, frmApplicationStatus, "2");
};

function frmApplicationStatus_frmApplicationStatus_preshow_seq0(eventobject, neworientation) {
...
function frmApplicationStatus_frmApplicationStatus_onOrientationChange_seq0(eventobject, neworientation) {
    /* 
leftMenuAssignment.call(this,frmApplicationStatus, gvModuleSelect);

 */
    frmOrient.call(this, frmApplicationStatus);
    leftMenuUiSelect.call(this, "2.2", frmApplicationStatus);
    /* 
onfrmOrientionChange.call(this,frmApplicationStatus);

 */
};

function frmApplicationStatus_vbxMale_onClick_seq0(eventobject) {
    setGender.call(this, true, frmApplicationStatus.rbImagStatus, frmApplicationStatus.rbimgInquiry);
};

function frmApplicationStatus_vbxFemale_onClick_seq0(eventobject) {
    setGender.call(this, false, frmApplicationStatus.rbImagStatus, frmApplicationStatus.rbimgInquiry);
};

function frmApplicationStatus_txtBoxAppNum_onTextChange_seq0(eventobject, changedtext) {
    SknTxtChangeValidation.call(this, frmApplicationStatus.lblApplicationNo);
};

function frmApplicationStatus_btnSubmit_onClick_seq0(eventobject) {
    clearinquirytabonfind.call(this);
    validateStatusPgFieldAndNav.call(this);
};

function frmApplicationStatus_btnClear_onClick_seq0(eventobject) {
...
function addWidgetsfrmApplicationStatus() {
    ...
    hbox172579614694751.add(
    label172579614694788);
    ...
    var vbxMale = new kony.ui.Box({
        "id": "vbxMale",
        "isVisible": true,
        "onClick": frmApplicationStatus_vbxMale_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 6,
        "margin": [0, 0, 0, 0],
    ...
    var vbxFemale = new kony.ui.Box({
        "id": "vbxFemale",
        "isVisible": true,
        "onClick": frmApplicationStatus_vbxFemale_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 6,
        "margin": [0, 0, 0, 0],
    ...
    hbox1818863783407523.add(
    vbxFemale, lblInquiry);
    ...
    var txtBoxAppNum = new kony.ui.TextBox2({
        ...
        "onTextChange": frmApplicationStatus_txtBoxAppNum_onTextChange_seq0,
        "skin": "sknTxtFields",
    ...
    hbox172579614692570.add(
    vbox172579614692571, vbox172579614692572);
    ...
    var btnSubmit = new kony.ui.Button({
        ...
        "onClick": frmApplicationStatus_btnSubmit_onClick_seq0
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "vExpand": false,
        "hExpand": true,
    ...
    var btnClear = new kony.ui.Button({
        ...
        "skin": "sknBtnSubmit",
        "focusSkin": "sknBtnSubmit",
        "onClick": frmApplicationStatus_btnClear_onClick_seq0
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "vExpand": false,
        "hExpand": true,
    ...
    label17230851704554127, lblEnquiryApplicationNoVal);
    ...
    hbox172308514247562, line1725796146117869, hbox172308514253338, line1725796146117870, hbox172308514255990, line1725796146117871, hbox172308514258666, line1725796146117872, hbox172308514261978);
    ...
    vbox17230851704554123.add(
    hbox17247832291488, line17230851704554139, hbox17247832294770, line1725796146117876, lblAppProgram, line155182739187460, segEnquiryCertificateDetails);
    ...
    hboxApplicationEnquiryStatus.add(
    vbox17230851704554123);
    ...
    hbox17230851704745681.add(
    label17230851704745683, lblApplicationNoVal);
    ...
    hbox17230851704745689.add(
    label17230851704745691, lblNameVal);
    ...
    hbox172478322913159, line1725796146117873, hbox172478322913207, line1725796146117874, hbox172478322916951, line1725796146117875, hbox172478322912523);
    ...
    vbox17230851704745679.add(
    line17230851704745695, hbox17230851704745681, line17230851704745687, hbox17230851704745689, lblCertificateDetails, segCertificateDetails);
    ...
    hboxApplicationStatusDetails.add(
    vbox17230851704745679);
    ...
    vbxRightMenu.add(
    hbox172579614694751, hbxGender, hbox1818863783407523, line172579614692573, hbox172579614692570, line172579614693138, hbox1818863783336137, hboxApplicationEnquiryStatus, hboxApplicationStatusDetails);
    ...
    frmApplicationStatus.add(
    hbox1727732536453133);
};

function frmApplicationStatusGlobals() {
    var MenuId = [];
    frmApplicationStatus = new kony.ui.Form2({
        ...
        "skin": "sknFrm",
        "init": frmApplicationStatus_frmApplicationStatus_init_seq0,
        "preShow": frmApplicationStatus_frmApplicationStatus_preshow_seq0,
        "onOrientationChange": frmApplicationStatus_frmApplicationStatus_onOrientationChange_seq0,
        "addWidgets": addWidgetsfrmApplicationStatus
    }, {
        "padding": [0, 0, 0, 0],
