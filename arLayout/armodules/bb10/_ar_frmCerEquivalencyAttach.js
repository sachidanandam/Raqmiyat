...
function addWidgetsfrmCerEquivalencyAttachAr() {
    ...
    frmCerEquivalencyAttachAr.add(    lblAttachments, lblDescription, txtDescription, line17239193183723059, button17228766339533, line172841775811748, button172761337239423, segAttachment, hbxcaptureimage, btnCertEquiSubmit, hbxFooter);
};
function frmCerEquivalencyAttachGlobalsAr() {
    ...
    frmCerEquivalencyAttachAr = new kony.ui.Form2({
        ...
        "titleBar": false,
        "directChildrenIDs": ["lblAttachments", "lblDescription", "line172841775811748", "btnCertEquiSubmit", "line17239193183723059", "segAttachment", "hbxcaptureimage", "camCertImage", "lblChoose", "hbxFooter", "vbox155182739219799", "lineFooter", "hbox155182739221589", "btnPrev", "lblStep5of5", "btnNext", "button172761337239423", "button17228766339533", "txtDescription"]
    });
};
