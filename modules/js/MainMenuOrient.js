...
function frmOrientLogo(curFrm)
{
	...
	{
		if(orients==0)
			frmMainMenu.imgMainMenuLogo.src="tablogo_portrait.png";
		else if(orients==1)
			frmMainMenu.imgMainMenuLogo.src="tablogo_land.png";
	}
	else
	{
		if(orients==1)
	...
	if(devicename=="iPad")
	{
		if(pageOrient==1)
		{
			if(PagId=="1")
			{
				...
				if(currlocale=="en_US")
						hbxhdrCertificateAttest.imghdrCertificateAttest.src="vert_ca.png";				
				else
						hbxhdrCertificateAttest.imghdrCertificateAttest.src="ar_vert_ca.png";
			...
			else
			{
				...
				if(currlocale=="en_US")
						hbxhdrCertificateEqui.iImgCertificateEquivalency.src="vert_ce.png";				
				else
						hbxhdrCertificateEqui.iImgCertificateEquivalency.src="ar_vert_ce.png";
