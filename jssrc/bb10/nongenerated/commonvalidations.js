...
function camCallbackImgSize(camObj) {
    try {
        ...
        if (attachLength > 25242880) return false;
        else return true;
    } catch (e) {
...
function msgBxCallBack(flag) {
    if (flag) if (gblErrWidgetRefId != null && gblErrWidgetRefId != "") {
...
function showConfirmationMsgWithHandle(msg, alertCallBack, yesBtnTxt, noBtnTxt) {
    ...
    if (yesBtnTxt == null || yesBtnTxt == "") yesBtnTxt = kony.i18n.getLocalizedString("lblYes");
    if (noBtnTxt == null || noBtnTxt == "") noBtnTxt = kony.i18n.getLocalizedString("lblNo");
    if (msgTxt == null || msgTxt == "") msgTxt = msg;
    var basicConf = {
        message: msgTxt,
