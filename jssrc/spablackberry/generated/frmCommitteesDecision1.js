...
function frmCommitteesDecision1_segCertificateDetails_onRowClick_seq0(eventobject, sectionNumber, rowNumber) {
    /* 
kony.print("Asdfghjkl " + (isArabicLocale==true)?frmCommitteesDecision1["segCertificateDetails"]["selectedItems"][0]["lblcountryar"]:frmCommitteesDecision1["segCertificateDetails"]["selectedItems"][0]["lblcountryen"]);
kony.print("Asdfghjkl isArabicLocale " + isArabicLocale);
kony.print("Asdfghjkl lblcountryar " + frmCommitteesDecision1["segCertificateDetails"]["selectedItems"][0]["lblcountryar"]);
kony.print("Asdfghjkl lblcountryen " + frmCommitteesDecision1["segCertificateDetails"]["selectedItems"][0]["lblcountryen"]);
