    ...
    if (kony.net.isNetworkAvailable(constants.NETWORK_TYPE_ANY)) {
        ...
        case "frmCertRequest3":
            if (curFrm.txtName = undefined || curFrm.txtName.text == "") {
                ...
                return false;
            } else if (!checkEmirateId(curFrm.txtIdentityNo.text)) {
                alertDialog(kony.i18n.getLocalizedString("lblEnterCorrectEmiratesID"));
                gblErrWidgetRefId = curFrm.txtIdentityNo;
                return false;
...
function clearInquirycerttab() {
    ...
    frmCertRequest.rbYes.src = "unchecked.png";
...
function clearInquirycertmob() {
    ...
    frmCertRequest1.rbYes.src = "unchecked.png";
...
function invokeUploadFileRequest(frmName, AppNo) {
    ...
    try {
        showLoadingIndicator(kony.i18n.getLocalizedString("lblProcessingReq"));
        var filename = frmName.segAttachment.data[0]["lblFileName"]; //(gblDeviceInfo == "tab") ? frmCertRequest.segAttachment.selectedItems[0]["lblFileName"] : frmCertRequest1.segAttachment.selectedItems[0]["lblFileName"];
