            ...
            if ((kony.os.toNumber(result.opstatus) == 0)) {
                ...
                if (result["output"] == "SUCCESS") {
                    ...
                    if (result["selectapp"] == undefined || result["selectapp"] == null) {
                        ...
                        if (gblDeviceInfo != "tab") {
                            frmCommitteesDecision1.lblApplicantName.text = result["selectapp"][0]["name_arb"];
                            frmCommitteesDecision1.lblappno.text = result["selectapp"][0]["app_no"];
                            kony.print(result["selectapp"][0]["name_arb"]);
                            ...
                            dismissLoadingIndicator();
                            kony.print("mobile set");
                        }
                        //tab
                        else {
                            frmCommitteesDecisionStaticPg.lblApplicantName.text = result["selectapp"][0]["name_arb"];
                            frmCommitteesDecisionStaticPg.lblappno.text = result["selectapp"][0]["app_no"];
                            loadcertificatereconsider();
        ...
        if (status == 400) {
            if ((kony.os.toNumber(result.opstatus) == 0)) {
                ...
                if (result["output"] == "SUCCESS") {
                    ...
                    comboboxData = [{
                        "mykey": "0",
                        "myvalue": "Please select objection type"
                    }];
    ...
    try {
        ...
        if (gblDeviceInfo != "tab") {
            var inputparam = {
                ...
                username: "webservice",
                password: "wEbsErViCe$35#",
                appno: frmCommitteesDecision2.lblApplicantNo.text,
            ...
            var inputparam = {
                ...
                username: "webservice",
                password: "wEbsErViCe$35#",
                appno: frmCommitteesDecisionStaticPg.lblApplicantNo.text,
