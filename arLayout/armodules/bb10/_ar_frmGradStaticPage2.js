...
function frmGradStaticPage2_frmGradStaticPage2_preshow_seq0Ar(eventobject, neworientation) {
    /* 
NFCSupport.call(this);
 */
    ValidateNFCSupport.call(this, frmGradStaticPage2);
};
function frmGradStaticPage2_frmGradStaticPage2_postshow_seq0Ar(eventobject, neworientation) {
    setLocaleBasedFooterTitle2.call(this, kony.application.getCurrentForm(), kony.i18n.getLocalizedString("lblStep2Of2"));
};
function frmGradStaticPage2_btnScan_onClick_seq0Ar(eventobject) {
    gvScannedCertType = 1;
    gvIsScanned = 1;
...
function frmGradStaticPage2_btnAtstatnReq_onClick_seq0Ar(eventobject) {
    gvScannedCertType = 1;
    gvIsScanned = 0;
    resetformValuesByTpe.call(this, frmMainMenu.lblGradStud.text);
    /* 
...
function addWidgetsfrmGradStaticPage2Ar() {
    ...
    var btnScan = new kony.ui.Button({
        ...
        "onClick": frmGradStaticPage2_btnScan_onClick_seq0Ar
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "vExpand": false,
        "hExpand": true,
    ...
    var btnAtstatnReq = new kony.ui.Button({
        ...
        "onClick": frmGradStaticPage2_btnAtstatnReq_onClick_seq0Ar
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "vExpand": false,
        "hExpand": true,
    ...
    vbox17228766336069074.add(    btnScan, btnAtstatnReq);
    ...
    hbxFotr.add(    vbox17228766336069074);
    frmGradStaticPage2Ar.add(    browGradInsStep2, hbox1239236892712889, hbxFotr);
};
function frmGradStaticPage2GlobalsAr() {
    var MenuId = [];
    frmGradStaticPage2Ar = new kony.ui.Form2({
        ...
        "skin": "sknFrm",
        "preShow": frmGradStaticPage2_frmGradStaticPage2_preshow_seq0Ar,
        "postShow": frmGradStaticPage2_frmGradStaticPage2_postshow_seq0Ar,
        "addWidgets": addWidgetsfrmGradStaticPage2Ar
    }, {
        "padding": [ 0, 0,0, 0],
        ...
        "titleBar": false,
        "directChildrenIDs": ["browGradInsStep2", "hbxFotr", "vbox17228766336069074", "btnAtstatnReq", "btnScan", "hbox1239236892712889", "lblHeaderSubTitle"]
    });
};
