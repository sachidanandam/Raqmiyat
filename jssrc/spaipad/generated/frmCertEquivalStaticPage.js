...
function addWidgetsfrmCertEquivalStaticPage() {
    ...
    var lblPageTitle = new kony.ui.Label({
        ...
        "i18n_text": "kony.i18n.getLocalizedString('lblPageTitle')"
    }, {
    ...
    var rtxtContent = new kony.ui.RichText({
        ...
        "skin": "sknRichText",
        "i18n_text": "kony.i18n.getLocalizedString('rtxtContent')"
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "contentAlignment": constants.CONTENT_ALIGN_MIDDLE_LEFT,
        "vExpand": false,
    ...
    var rtxtContent3 = new kony.ui.RichText({
        ...
        "skin": "sknRichTxtRed",
        "i18n_text": "kony.i18n.getLocalizedString('rtxtContent3')"
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "contentAlignment": constants.CONTENT_ALIGN_MIDDLE_LEFT,
        "vExpand": false,
    ...
    var btnRegister = new kony.ui.Button({
        ...
        "i18n_text": "kony.i18n.getLocalizedString('btnNext')"
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "vExpand": false,
        "hExpand": true,
    ...
    var lblInstructionRequirement = new kony.ui.Label({
        ...
        "i18n_text": "kony.i18n.getLocalizedString('lblInstructionRequirement')"
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "vExpand": false,
        "hExpand": true,
    ...
    vbxRightMenu.add(
    hbox17230851422554, hbox17230851423079, hbox172308514249095, btnRegister, hbox1239236892712889, browCertificateEuiqStep1);
