...
function frmMainMenu_frmMainMenu_postshow_seq0Ar(eventobject, neworientation) {
    setLocaleBasedHeaderTitle.call(this, kony.application.getCurrentForm(), kony.i18n.getLocalizedString("lblMainMenu"));
};

function frmMainMenu_frmMainMenu_onDeviceBack_seq0Ar(eventobject, neworientation) {
    doNothing.call(this);
};

function frmMainMenu_hbxMenu1_onClick_seq0Ar(eventobject) {
    showHideMenu.call(this, 1);
};

function frmMainMenu_vbxGraduate_onClick_seq0Ar(eventobject) {
...
function frmMainMenu_vbxCurrent_onClick_seq0Ar(eventobject) {
    frmCurntStudStatic.show();
};

function frmMainMenu_vbxFaculty_onClick_seq0Ar(eventobject) {
    frmFacultyStatic.show();
};

function frmMainMenu_hbxMenu2_onClick_seq0Ar(eventobject) {
    /* 
...
function frmMainMenu_vbox1818863783236213_onClick_seq0Ar(eventobject) {
    /* 
...
function frmMainMenu_vbox1818863783288502_onClick_seq0Ar(eventobject) {
    /* 
...
function frmMainMenu_vbox1818863783243638_onClick_seq0Ar(eventobject) {
    /* 
...
function frmMainMenu_hbox1818863783294434_onClick_seq0Ar(eventobject) {
    frmCommitteesDecisionStaticPage.show();
};

function frmMainMenu_vbox1818863783294438_onClick_seq0Ar(eventobject) {
    /* 
...
function frmMainMenu_hbxMenu3_onClick_seq0Ar(eventobject) {
...
function addWidgetsfrmMainMenuAr() {
    ...
    var hbxMenu1 = new kony.ui.Box({
        ...
        "isVisible": true,
        "skin": "sknHbxMenu",
        "onClick": frmMainMenu_hbxMenu1_onClick_seq0Ar,
    ...
    hbxMenu1.add(lblMenu1, imgMenu1);
    ...
    var vbxGraduate = new kony.ui.Box({
        ...
        "onClick": frmMainMenu_vbxGraduate_onClick_seq0Ar,
    ...
    hbxGradStud.add(vbxGraduate, image2153428946633834);
    ...
    var vbxCurrent = new kony.ui.Box({
        ...
        "isVisible": true,
        "skin": "sknVbxMenuBorder",
        "onClick": frmMainMenu_vbxCurrent_onClick_seq0Ar,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 86,
        "margin": [0, 0, 0, 0],
    ...
    hbxCurStud.add(vbxCurrent, image2153428946639018);
    ...
    var vbxFaculty = new kony.ui.Box({
        ...
        "isVisible": true,
        "skin": "sknVbxMenuBorder",
        "onClick": frmMainMenu_vbxFaculty_onClick_seq0Ar,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 86,
        "margin": [0, 0, 0, 0],
    ...
    hbxFacMem.add(vbxFaculty, image2153428946654162);
    ...
    vboxCertAset.add(hbxGradStud, hbxCurStud, hbxFacMem);
    ...
    var hbxMenu2 = new kony.ui.Box({
        ...
        "onClick": frmMainMenu_hbxMenu2_onClick_seq0Ar,
        "position": constants.BOX_POSITION_AS_NORMAL,
        "orientation": constants.BOX_LAYOUT_HORIZONTAL
    }, {
        "containerWeight": 10,
    ...
    hbxMenu2.add(lblMenu2, imgMenu2);
    ...
    var vbox1818863783236213 = new kony.ui.Box({
        ...
        "isVisible": true,
        "skin": "sknVbxMenuBorder",
        "onClick": frmMainMenu_vbox1818863783236213_onClick_seq0Ar,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 86,
        "margin": [0, 0, 0, 0],
    ...
    vbox1818863783236213.add(lblCertEqu);
    ...
    hbox1818863783236209.add(vbox1818863783236213, image21818863783236211);
    ...
    var vbox1818863783288502 = new kony.ui.Box({
        ...
        "isVisible": true,
        "skin": "sknVbxMenuBorder",
        "onClick": frmMainMenu_vbox1818863783288502_onClick_seq0Ar,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 86,
        "margin": [0, 0, 0, 0],
    ...
    vbox1818863783288502.add(lblStatusOfCert);
    ...
    hbox1818863783288498.add(vbox1818863783288502, image21818863783288500);
    ...
    var vbox1818863783243638 = new kony.ui.Box({
        ...
        "isVisible": true,
        "skin": "sknVbxMenuBorder",
        "onClick": frmMainMenu_vbox1818863783243638_onClick_seq0Ar,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 86,
        "margin": [0, 0, 0, 0],
    ...
    vbox1818863783243638.add(lblPageTitle3);
    ...
    hbox1818863783243634.add(vbox1818863783243638, image21818863783243636);
    ...
    var vbox1818863783294438 = new kony.ui.Box({
        ...
        "isVisible": true,
        "skin": "sknVbxMenuBorder",
        "onClick": frmMainMenu_vbox1818863783294438_onClick_seq0Ar,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 86,
        "margin": [0, 0, 0, 0],
    ...
    vbox1818863783294438.add(lblCommitDec);
    var hbox1818863783294434 = new kony.ui.Box({
        "id": "hbox1818863783294434",
        "isVisible": true,
        "onClick": frmMainMenu_hbox1818863783294434_onClick_seq0Ar,
        "position": constants.BOX_POSITION_AS_NORMAL,
        "orientation": constants.BOX_LAYOUT_HORIZONTAL
    }, {
        "containerWeight": 25,
    ...
    hbox1818863783294434.add(vbox1818863783294438, image21818863783294436);
    ...
    vbox1818863783350283.add(hbox1818863783236209, hbox1818863783288498, hbox1818863783243634, hbox1818863783294434);
    ...
    hboxCert.add(vbox1818863783350283);
    ...
    var hbxMenu3 = new kony.ui.Box({
        ...
        "isVisible": false,
        "skin": "sknHbxMenu",
        "onClick": frmMainMenu_hbxMenu3_onClick_seq0Ar,
        "position": constants.BOX_POSITION_AS_NORMAL,
        "orientation": constants.BOX_LAYOUT_HORIZONTAL
    }, {
        "containerWeight": 10,
    ...
    hbxMenu3.add(lblMenu3, imgMenu3);
    ...
    vbox1238998564730125.add(imgFooter);
    ...
    hboxLogo.add(vbox1238998564730125);
    frmMainMenuAr.add(hbxMenu1, hboxCertAset, hbxMenu2, hboxCert, hbxMenu3, hboxLogo);
};
...
function frmMainMenuGlobalsAr() {
    ...
    frmMainMenuAr = new kony.ui.Form2({
        ...
        "postShow": frmMainMenu_frmMainMenu_postshow_seq0Ar,
        ...
        "titleBar": false,
        "onDeviceBack": frmMainMenu_frmMainMenu_onDeviceBack_seq0Ar,
        "directChildrenIDs": ["hbxMenu1", "lblMenu1", "imgMenu1", "hbxMenu2", "lblMenu2", "imgMenu2", "hbxMenu3", "lblMenu3", "imgMenu3", "hboxLogo", "vbox1238998564730125", "imgFooter", "hboxCert", "vbox1818863783350283", "hbox1818863783236209", "image21818863783236211", "vbox1818863783236213", "lblCertEqu", "hbox1818863783243634", "image21818863783243636", "vbox1818863783243638", "lblPageTitle3", "hbox1818863783288498", "image21818863783288500", "vbox1818863783288502", "lblStatusOfCert", "hbox1818863783294434", "image21818863783294436", "vbox1818863783294438", "lblCommitDec", "hboxCertAset", "vboxCertAset", "hbxFacMem", "image2153428946654162", "vbxFaculty", "lblFacMem", "hbxCurStud", "image2153428946639018", "vbxCurrent", "lblCurStud", "hbxGradStud", "image2153428946633834", "vbxGraduate", "lblGradStud"]
    });
};