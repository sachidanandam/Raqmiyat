...
function frmCerEquivalencyAttach_frmCerEquivalencyAttach_preshow_seq0Ar(eventobject, neworientation) {
    /* 
retriveImagesFromGallery.call(this);
 */
};
function frmCerEquivalencyAttach_frmCerEquivalencyAttach_postshow_seq0Ar(eventobject, neworientation) {
...
function frmCerEquivalencyAttach_button17228766339533_onClick_seq0Ar(eventobject) {
    loadreqdocs.call(this);
};
...
function frmCerEquivalencyAttach_button18124586868704_onClick_seq0Ar(eventobject) {
...
function addWidgetsfrmCerEquivalencyAttachAr() {
    ...
    var button17228766339533 = new kony.ui.Button({
        ...
        "onClick": frmCerEquivalencyAttach_button17228766339533_onClick_seq0Ar
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "vExpand": false,
        "hExpand": true,
    ...
    var button18124586868704 = new kony.ui.Button({
        ...
        "skin": "skmCamera",
        "focusSkin": "btnFocus",
        "onClick": frmCerEquivalencyAttach_button18124586868704_onClick_seq0Ar
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "vExpand": false,
        "hExpand": true,
    ...
    hbxcaptureimage.add(     button18124586868704,lblChoose);
    ...
    frmCerEquivalencyAttachAr.add(    lblAttachments, lblDescription, txtDescription, line17239193183723059, button17228766339533, line172841775811748, button172761337239423, hbxcaptureimage, segAttachment, btnCertEquiSubmit, hbxFooter);
};
function frmCerEquivalencyAttachGlobalsAr() {
    ...
    frmCerEquivalencyAttachAr = new kony.ui.Form2({
        ...
        "skin": "sknFrm",
        "preShow": frmCerEquivalencyAttach_frmCerEquivalencyAttach_preshow_seq0Ar,
        "postShow": frmCerEquivalencyAttach_frmCerEquivalencyAttach_postshow_seq0Ar,
