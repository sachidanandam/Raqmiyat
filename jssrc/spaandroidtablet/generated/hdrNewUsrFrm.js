...
function initializehdrNewUsrFrm() {
    hbox17257961466800 = new kony.ui.Box({
    ...
    addWidgetshbox17257961466800();
    hboxnewhdrtitle = new kony.ui.Box({
        "id": "hboxnewhdrtitle",
        "isVisible": true,
        "skin": "sknMenuFrmHdr",
        "orientation": constants.BOX_LAYOUT_HORIZONTAL
    ...
    function addWidgetshboxnewhdrtitle() {
        var lblHeaderSubTitle = new kony.ui.Label({
            ...
            "i18n_text": "kony.i18n.getLocalizedString('lblNewRegistration')"
        }, {
            "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
            "vExpand": false,
            "hExpand": true,
