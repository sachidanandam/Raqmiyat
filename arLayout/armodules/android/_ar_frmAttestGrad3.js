...
function frmAttestGrad3_frmAttestGrad3_preshow_seq0Ar(eventobject, neworientation) {
...
function frmAttestGrad3_frmAttestGrad3_postshow_seq0Ar(eventobject, neworientation) {
    if (!gblNfcFlag) {
        frmAttestGrad3.dropdownstudylevel.masterDataMap = [
            [{
                "key": "0",
                "value": kony.i18n.getLocalizedString("lblPleaseSelectStudyLevel")
            }, {
                "key": "30",
                "value": kony.i18n.getLocalizedString("lblSecondarySchool")
            }, {
                "key": "5",
                "value": kony.i18n.getLocalizedString("lblAssociateDegree")
            }, {
                "key": "4",
                "value": kony.i18n.getLocalizedString("lblAssociateDegree")
            }, {
                "key": "3",
                "value": kony.i18n.getLocalizedString("lblPostGradDiploma")
            }, {
                "key": "2",
                "value": kony.i18n.getLocalizedString("lblMaster")
            }], "key", "value"];
        frmAttestGrad3.dropdownstudylevel.setEnabled(true);
        frmAttestGrad3.dropdownnationality.setEnabled(true);
    }
};
function frmAttestGrad3_txtinstitutename_onTextChange_seq0Ar(eventobject, changedtext) {
    SknTxtChangeValidation.call(this, frmAttestGrad3.lblInstituteName);
};
function frmAttestGrad3_txtmajor_onTextChange_seq0Ar(eventobject, changedtext) {
    SknTxtChangeValidation.call(this, frmAttestGrad3.lblMajor);
};
function frmAttestGrad3_vbxNo_onClick_seq0Ar(eventobject) {
    setIsCertificateAttested.call(this, false);
};
function frmAttestGrad3_vbxYes_onClick_seq0Ar(eventobject) {
    setIsCertificateAttested.call(this, true);
};
function frmAttestGrad3_txtinstitutename2_onTextChange_seq0Ar(eventobject, changedtext) {
    SknTxtChangeValidation.call(this, frmAttestGrad3.lblInstituteNameCert);
};
function frmAttestGrad3_dropdownnationality_onSelection_seq0Ar(eventobject) {
    SknTxtChangeValidation.call(this, frmAttestGrad3.lblCountry);
};
function frmAttestGrad3_txtcredithours_onTextChange_seq0Ar(eventobject, changedtext) {
    SknTxtChangeValidation.call(this, frmAttestGrad3.lblCreditHours);
};
function frmAttestGrad3_hbxcaptureimage_onClick_seq0Ar(eventobject) {
    launchDeviceCamera.call(this, kony.application.getCurrentForm());
};
function frmAttestGrad3_camCertImage_onCapture_seq0Ar(eventobject) {
    camCallbackAttestStep3.call(this, eventobject);
};
function frmAttestGrad3_btnSubmit_onClick_seq0Ar(eventobject) {
    createAttestGrad3Obj.call(this);
    onBtnClickSubmitAttestStep3.call(this);
    attachalert = false;
};
function addWidgetsfrmAttestGrad3Ar() {
    ...
    var dropdownstudylevel = new kony.ui.ComboBox({
        ...
        "isVisible": false,
        "masterData": [["0", kony.i18n.getLocalizedString("lblPleaseSelectStudyLevel")],["30", kony.i18n.getLocalizedString("lblSecondarySchool")],["5", kony.i18n.getLocalizedString("lblAssociateDegree")],["4", kony.i18n.getLocalizedString("lblBachelor")],["3", kony.i18n.getLocalizedString("lblPostGradDiploma")],["2", kony.i18n.getLocalizedString("lblMaster")]],
        "selectedKey": "0",
        "skin": "cmbSkin",
        "focusSkin": "cmbSkin"
    }, {
    ...
    var txtinstitutename = new kony.ui.TextBox2({
        ...
        "onTextChange": frmAttestGrad3_txtinstitutename_onTextChange_seq0Ar,
        "skin": "sknTxtFields",
    ...
    var txtmajor = new kony.ui.TextBox2({
        ...
        "autoCapitalize": constants.TEXTBOX_AUTO_CAPITALIZE_NONE,
        "onTextChange": frmAttestGrad3_txtmajor_onTextChange_seq0Ar,
        "skin": "sknTxtFields",
        "focusSkin": "sknTxtFields",
        "keyBoardStyle": constants.TEXTBOX_KEY_BOARD_STYLE_DEFAULT
    }, {
    ...
    var vbxNo = new kony.ui.Box({
        "id": "vbxNo",
        "isVisible": true,
        "onClick": frmAttestGrad3_vbxNo_onClick_seq0Ar,
    ...
    var vbxYes = new kony.ui.Box({
        "id": "vbxYes",
        "isVisible": true,
        "onClick": frmAttestGrad3_vbxYes_onClick_seq0Ar,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 50,
        "margin": [ 0, 0,0, 0],
    ...
    hbxCertAttest.add(     vbxYes,vbxNo);
    ...
    var txtinstitutename2 = new kony.ui.TextBox2({
        ...
        "placeholder": kony.i18n.getLocalizedString("lblEnterName"),
        "autoCapitalize": constants.TEXTBOX_AUTO_CAPITALIZE_NONE,
        "onTextChange": frmAttestGrad3_txtinstitutename2_onTextChange_seq0Ar,
        "skin": "sknTxtFields",
        "focusSkin": "sknTxtFields",
        "keyBoardStyle": constants.TEXTBOX_KEY_BOARD_STYLE_DEFAULT
    }, {
    ...
    var dropdownnationality = new kony.ui.ComboBox({
        ...
        "skin": "cmbSkin",
        "focusSkin": "cmbSkin",
        "onSelection": frmAttestGrad3_dropdownnationality_onSelection_seq0Ar
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "vExpand": false,
        "hExpand": true,
    ...
    var txtcredithours = new kony.ui.TextBox2({
        ...
        "placeholder": kony.i18n.getLocalizedString("lblEnterHere"),
        "autoCapitalize": constants.TEXTBOX_AUTO_CAPITALIZE_NONE,
        "onTextChange": frmAttestGrad3_txtcredithours_onTextChange_seq0Ar,
        "skin": "sknTxtFields",
        "focusSkin": "sknTxtFields",
    ...
    var camCertImage = new kony.ui.Camera({
        ...
        "focusSkin": "camFocus",
        "onCapture": frmAttestGrad3_camCertImage_onCapture_seq0Ar,
        "scaleFactor": 80,
        "compressionLevel": 0
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
    ...
    var hbxcaptureimage = new kony.ui.Box({
        ...
        "skin": "sknHbxCam",
        "focusSkin": "sknHbxCam",
        "onClick": frmAttestGrad3_hbxcaptureimage_onClick_seq0Ar,
        "position": constants.BOX_POSITION_AS_NORMAL,
        "orientation": constants.BOX_LAYOUT_HORIZONTAL
    }, {
        "containerWeight": 6,
    ...
    var btnSubmit = new kony.ui.Button({
        ...
        "onClick": frmAttestGrad3_btnSubmit_onClick_seq0Ar
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
        "vExpand": false,
        "hExpand": true,
...
function frmAttestGrad3GlobalsAr() {
    ...
    frmAttestGrad3Ar = new kony.ui.Form2({
        ...
        "skin": "sknFrm",
        "preShow": frmAttestGrad3_frmAttestGrad3_preshow_seq0Ar,
        "postShow": frmAttestGrad3_frmAttestGrad3_postshow_seq0Ar,
        "addWidgets": addWidgetsfrmAttestGrad3Ar
    }, {
        "padding": [ 0, 0,0, 0],
