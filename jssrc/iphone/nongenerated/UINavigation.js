...
function goTofrm2() {
    if (kony.net.isNetworkAvailable(constants.NETWORK_TYPE_ANY)) {
        ...
        if (!gblNfcFlag) getInstitutesList();
        else getPaymentMethodTypes();
        frmAttestGrad2.show();
    } else {
        alert(kony.i18n.getLocalizedString("lblNetworkMsg"));
    }
...
function loadi18GraStudStep1() {
    ...
    } else frmGradStaticPage1.browGradInsStep1.htmlString = kony.i18n.getLocalizedString("lblGradStaticTextStep1");
}
