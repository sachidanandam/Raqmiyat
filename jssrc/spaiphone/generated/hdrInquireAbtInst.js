...
function initializehdrInquireAbtInst() {
    hbox172311493310632 = new kony.ui.Box({
    ...
    addWidgetshbox172311493310632();
    hbox172311493310656 = new kony.ui.Box({
    ...
    function addWidgetshbox172311493310656() {
        var lblPgSubHdrName = new kony.ui.Label({
            ...
            "i18n_text": "kony.i18n.getLocalizedString('lblinquireaboutinstprog')"
        }, {
            "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
            "vExpand": false,
            "hExpand": true,
