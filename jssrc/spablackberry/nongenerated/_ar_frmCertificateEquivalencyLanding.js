...
function addWidgetsfrmCertificateEquivalencyLandingAr() {
    ...
    var segRegisteredCertificate = new kony.ui.SegmentedUI2({
        ...
        "widgetDataMap": {
            ...
            "lblRegCertCountry": "lblRegCertCountry",
            "vbox1724008663205079": "vbox1724008663205079",
            "vbox1724008663145390": "vbox1724008663145390",
            "lblRegCertTitle": "lblRegCertTitle",
            "lblRegCertObjectionType": "lblRegCertObjectionType",
            "lblRegCertMajorDetails": "lblRegCertMajorDetails",
            "lblRegCertTitleDetails": "lblRegCertTitleDetails",
            "lblRegCertCountryDetails": "lblRegCertCountryDetails",
            "imgNext": "imgNext",
            "lblRegCertMajor": "lblRegCertMajor",
            ...
            "lblRegCertObjectionTypeDetails": "lblRegCertObjectionTypeDetails"
        },
        "data": [{
            "imgNext": "next.png",
            "lblRegCertMajor": "Certificate",
            "lblRegCertCountry": "Study Level",
            "lblRegCertObjectionType": "Status",
            "lblRegCertTitle": "Certificate No",
            "lblRegCertMajorDetails": "Civil Engineering",
            "lblRegCertObjectionTypeDetails": "No Objection",
            "lblRegCertCountryDetails": "India",
            "lblRegCertTitleDetails": ""
        }],
    ...
    var lblRegCertTitle = new kony.ui.Label({
        "id": "lblRegCertTitle",
        "isVisible": true,
        "skin": "sknLblFields"
    }, {
    ...
    var lblRegCertTitleDetails = new kony.ui.Label({
        "id": "lblRegCertTitleDetails",
        "isVisible": true,
    ...
    hbox1724008663170544.add(lblRegCertTitleDetails, lblRegCertTitle);
    var lblRegCertMajor = new kony.ui.Label({
        "id": "lblRegCertMajor",
        "isVisible": true,
        "skin": "sknLblFields"
    }, {
    ...
    var lblRegCertMajorDetails = new kony.ui.Label({
        "id": "lblRegCertMajorDetails",
        "isVisible": true,
        "skin": "sknLblHighlight"
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
    ...
    hbox1724008663170556.add(lblRegCertMajorDetails, lblRegCertMajor);
    var lblRegCertCountry = new kony.ui.Label({
        "id": "lblRegCertCountry",
        "isVisible": true,
        "skin": "sknLblFields"
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
    ...
    var lblRegCertCountryDetails = new kony.ui.Label({
        "id": "lblRegCertCountryDetails",
        "isVisible": true,
        "skin": "sknLblHighlight"
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
    ...
    hbox1724008663183984.add(lblRegCertCountryDetails, lblRegCertCountry);
    var lblRegCertObjectionType = new kony.ui.Label({
        "id": "lblRegCertObjectionType",
        "isVisible": true,
        "skin": "sknLblFields"
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
    ...
    var lblRegCertObjectionTypeDetails = new kony.ui.Label({
        "id": "lblRegCertObjectionTypeDetails",
        "isVisible": true,
        "skin": "sknLblHighlight"
    }, {
        "widgetAlignment": constants.WIDGET_ALIGN_CENTER,
    ...
    hbox1724008663190824.add(lblRegCertObjectionTypeDetails, lblRegCertObjectionType);
    ...
    frmCertificateEquivalencyLandingAr.add(hbox17239193183868225, line172391929013832, lblRegisteredCertificates, line172391929013849, segRegisteredCertificate, btnRegNewCertificate);
};
...
function frmCertificateEquivalencyLandingGlobalsAr() {
    ...
    frmCertificateEquivalencyLandingAr = new kony.ui.Form2({
        ...
        "titleBar": true,
        "directChildrenIDs": ["line172391929013832", "line172391929013849", "segRegisteredCertificate", "lblRegisteredCertificates", "hbox17239193183868225", "lblApplicantName", "btnRegNewCertificate"]
    });
};