...
function frmCurntStudStatic_frmCurntStudStatic_onOrientationChange_seq0(eventobject, neworientation) {
    /* 
...
function frmCurntStudStaticGlobals() {
    ...
    frmCurntStudStatic = new kony.ui.Form2({
        ...
        "onOrientationChange": frmCurntStudStatic_frmCurntStudStatic_onOrientationChange_seq0,
