...
function frmCertRequest1_vbxAttestOutside_onClick_seq0Ar(eventobject) {
    ...
    frmCertRequest1.lblDescription.isVisible = true;
    frmCertRequest1.txtDescription.isVisible = true;
};
...
function frmCertRequest1_vbox1818863783308050_onClick_seq0Ar(eventobject) {
    ...
    frmCertRequest1.lblDescription.isVisible = false;
    frmCertRequest1.txtDescription.isVisible = false;
};
